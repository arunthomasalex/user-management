package com.application.usermanagemet.config;

import com.application.usermanagemet.config.filter.JwtOncePerRequestFilter;
import com.application.usermanagemet.config.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public JwtOncePerRequestFilter jwtAuthenticationFilter() {
